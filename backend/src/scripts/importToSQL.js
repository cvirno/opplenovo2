...
async function importToSQL() {
    try {
        ...
        for (const regional of data.regionais || []) {
            try {
                await sql.query`
        ...
        for (const oportunidade of data.oportunidades || []) {
            try {
                await sql.query`
        ...
        for (const historico of data.historicoOportunidades || []) {
            try {
                await sql.query`
